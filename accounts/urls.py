...
urlpatterns = [
    # Add authentication URLs (login, logout, password reset)
    path('', include("django.contrib.auth.urls")),  # This includes the default auth URLs (login, logout, password reset, etc.)
